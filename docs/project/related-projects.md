...
- [inseri core](https://wordpress.org/plugins/inseri-core/) is a WordPress plugin developed that introduces scientific and interactive Gutenberg blocks to facilitate open science. The [Python Code block](https://docs.inseri.swiss/blocks/python/) allows to run Python code in the browser.
